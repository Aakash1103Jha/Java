 ...
 * Method named getLastName without any parameters, it needs to return the value
 ...
 * Method named setAge with one parameter of type int, it needs to set the value
 * of the age field. If the parameter is less than 0 or greater than 100, it
 * needs to set the age field value to 0.
 ...
 * name of the person.
 * In case both firstName and lastName fields are empty, Strings return an empty
 * String.
